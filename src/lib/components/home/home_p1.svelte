...
<div class="flex flex-col h-screen bg-slate-900 overflow-clip border-dashed border-2 md:border-4 border-stone-50">
	<div class="relative h-screen">
		<div
			class=" absolute top-0 left-0 right-0 bottom-0 flex items-center justify-center text-center"
		>
			<p
				class="text-l md:text-3xl absolute left-1 md:left-10 text-slate-300 z-10"
			...
			/>
			<p
				class="text-l md:text-3xl absolute right-1 md:right-10 text-slate-300 z-10"
		...
		>
			<a
				href="/gallery"
				class="mix-blend-difference text-slate-300 font-bold text-[22vw]"
